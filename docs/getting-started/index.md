...
| | Android as Sleep | :material-cellphone: :material-watch: | This app is the most reliable sleep tracker for Android. Make sure to turn off the features that send your data to the developer. It is deeply integrated into the way the sleep track flow works. | [Google Play](https://play.google.com/store/apps/details?id=com.urbandroid.sleep) | (Docs)[https://www.docs.sleep.urbandroid.org/services/automation.html] |
